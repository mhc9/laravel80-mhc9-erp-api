...
class AttendanceApprovalDetail extends Model
{
    protected $table = 'attendance_approval_details';
    ...
    {
        return $this->belongsTo(AttendanceApproval::class, 'attendance_approval_id', 'id');
    }
